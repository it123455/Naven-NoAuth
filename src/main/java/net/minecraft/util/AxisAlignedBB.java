...
public class AxisAlignedBB {
    ...
    public double calculateDistanceTo(Vec3 point) {
        double distanceX = Math.max(0.0, Math.max(this.minX - point.xCoord, point.xCoord - this.maxX));
        double distanceY = Math.max(0.0, Math.max(this.minY - point.yCoord, point.yCoord - this.maxY));
        double distanceZ = Math.max(0.0, Math.max(this.minZ - point.zCoord, point.zCoord - this.maxZ));
