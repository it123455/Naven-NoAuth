...
public class GuiIngame extends Gui {
    ...
    public void renderGameOverlay(float partialTicks) {
        ...
        Naven.getInstance().glslShaderUpdate();
        ...
        GlStateManager.pushMatrix();
        Naven.getInstance().getEventManager().call(new EventRender2D(scaledresolution));
        GlStateManager.color(1, 1, 1, 1);
        GlStateManager.popMatrix();

        if (this.titlesTimer > 0 && !Naven.getInstance().getModuleManager().getModule(NoTitle.class).isEnabled()) {
        ...
        GlStateManager.pushMatrix();
        Naven.getInstance().getEventManager().call(new EventRenderUI(scaledresolution));
        GlStateManager.color(1, 1, 1, 1);
        GlStateManager.popMatrix();
    }
    ...
    private void renderScoreboard(ScoreObjective objective, ScaledResolution scaledRes) {
        ...
        moe.ichinomiya.naven.modules.impl.render.Scoreboard module = (moe.ichinomiya.naven.modules.impl.render.Scoreboard) Naven.getInstance().getModuleManager().getModule(moe.ichinomiya.naven.modules.impl.render.Scoreboard.class);
