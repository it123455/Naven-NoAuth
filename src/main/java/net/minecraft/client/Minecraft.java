...
import static moe.ichinomiya.naven.utils.RenderUtils.mc;
...
public class Minecraft implements IThreadListener {
    ...
    public void shutdownMinecraftApplet() {
        try {
            ...
            Naven.getInstance().onClientShutdown();
    ...
    private void runGameLoop() throws IOException {
        ...
        EventManager eventManager = Naven.getInstance().getEventManager();
        ...
        if (!this.skipRenderWorld) {
            boolean shouldCall = Naven.getInstance() != null && Naven.getInstance().getEventManager() != null;
            if (shouldCall) {
                Naven.getInstance().getEventManager().call(new EventRenderTick(EventType.PRE));
            }
            ...
            if (shouldCall) {
                Naven.getInstance().getEventManager().call(new EventRenderTick(EventType.POST));
            }
        }
    ...
    private void rightClickMouse() {
        OffhandFeatures offhand = (OffhandFeatures) Naven.getInstance().getModuleManager().getModule(OffhandFeatures.class);
    ...
    public void runTick() throws IOException {
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            while (Mouse.next()) {
                ...
                if (i != -1) {
                    Naven.getInstance().getEventManager().call(new EventMouseClick(i, Mouse.getEventButtonState()));
                }
            ...
            while (Keyboard.next()) {
                ...
                if (Keyboard.getEventKey() != 0) {
                    Naven.getInstance().getEventManager().call(new EventKey(Keyboard.getEventKey(), Keyboard.getEventKeyState()));
                }
            ...
            Naven.getInstance().getEventManager().call(eventClick);
        ...
        if (Naven.getInstance() != null && Naven.getInstance().getEventManager() != null) {
            Naven.getInstance().getEventManager().call(new EventRunTicks());
        }
    }
    ...
    public void loadWorld(WorldClient worldClientIn, String loadingMessage) {
        ...
        if (this.theWorld != null) {
            Naven.getInstance().getEventManager().call(new EventWorldUnload());
        }
        ...
        if (this.objectMouseOver != null) {
            ...
            if (this.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
                ...
                if (objectMouseOver.entityHit != null) {
                    Naven.getInstance().getEventManager().call(new EventMiddleClickEntity(objectMouseOver.entityHit));
                }
