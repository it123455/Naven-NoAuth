...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T> {
    ...
    public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks) {
        ...
        try {
            ...
            Naven.getInstance().getEventManager().call(evt);
        ...
        Naven.getInstance().getEventManager().call(new EventRendererLivingEntity(EventType.POST, entity));
    ...
    public void renderName(T entity, double x, double y, double z) {
        if (Naven.getInstance().getModuleManager().getModule(NameTags.class).isEnabled() && entity instanceof EntityPlayer) {
            return;
        }
