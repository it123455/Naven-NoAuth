...
public class ItemCameraTransforms {
    ...
    public void applyTransform(ItemCameraTransforms.TransformType type) {
        ...
        if (type == TransformType.FIRST_PERSON_OFFHAND) {

            itemtransformvec3f = new ItemTransformVec3f(new Vector3f(0, -135, 25), new Vector3f(0, 0.25f, 0.125f), new Vector3f(1.7f, 1.7f, 1.7f));
        }
