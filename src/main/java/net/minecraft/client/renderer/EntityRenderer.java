...
public class EntityRenderer implements IResourceManagerReloadListener {
    ...
    public void updateRenderer() {
        ...
        if (Naven.getInstance().getModuleManager() != null) {
            module = Naven.getInstance().getModuleManager().getModule(NoSmoothCamera.class);
        }
    ...
    public void getMouseOver(float partialTicks) {
        ...
        if (entity != null && this.mc.theWorld != null) {
            ...
            for (Entity entity1 : list) {
                try {
                    ...
                    if (Teams.isSameTeam(entity1) && ((Teams) Naven.getInstance().getModuleManager().getModule(Teams.class)).removeHitbox.getCurrentValue()) {
                        continue;
                    }
        ...
        Naven.getInstance().getEventManager().call(new EventMouseOver());
    }
    ...
    private void hurtCameraEffect(float partialTicks) {
        if (Naven.getInstance().getModuleManager().getModule(NoHurtCam.class).isEnabled()) {
            return;
        }
    ...
    public void updateCameraAndRender(float partialTicks, long nanoTime) {
        ...
        if (this.mc.inGameHasFocus && flag) {
            ...
            if (Naven.getInstance().getModuleManager() != null) {
                module = (NoSmoothCamera) Naven.getInstance().getModuleManager().getModule(NoSmoothCamera.class);
            }
    ...
    public void call3DRenderEvent(float renderPartialTicks) {
        ...
        Naven.getInstance().getEventManager().call(new EventRender(renderPartialTicks));
    ...
    private void setupFog(int startCoords, float partialTicks) {
        ...
        if (f >= 0.0F) {
            ...
            if (!Naven.getInstance().getModuleManager().getModule(NoLiquidFog.class).isEnabled()) {
                GlStateManager.setFog(2048);
