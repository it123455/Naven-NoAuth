...
public class EntityPlayerSP extends AbstractClientPlayer {
    ...
    public void onLivingUpdate() {
        ...
        Naven.getInstance().getEventManager().call(slowdownEvent);
        ...
        if (!Naven.getInstance().getModuleManager().getModule(Stuck.class).isEnabled()) {
            if (this.onGround && !flag1 && !flag2 && this.movementInput.moveForward >= f && !this.isSprinting() && flag3 && (!this.isUsingItem() || Naven.getInstance().getModuleManager().getModule(NoSlow.class).isEnabled()) && !this.isPotionActive(Potion.blindness)) {
            ...
            if (!this.isSprinting() && this.movementInput.moveForward >= f && flag3 && (!this.isUsingItem() || Naven.getInstance().getModuleManager().getModule(NoSlow.class).isEnabled()) && !this.isPotionActive(Potion.blindness) && this.mc.gameSettings.keyBindSprint.isKeyDown()) {
                this.setSprinting(true);
            }
