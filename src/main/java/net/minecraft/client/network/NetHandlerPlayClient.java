...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
    ...
    public void handleJoinGame(S01PacketJoinGame packetIn) {
        ...
        // Client
        Naven.getInstance().getEventManager().call(new EventRespawn(EventType.JOIN_GAME));
    }
    ...
    public void handleSpawnPlayer(S0CPacketSpawnPlayer packetIn) {
        ...
        Naven.getInstance().getEventManager().call(new EventSpawnPlayer(entityotherplayermp));
    }
    ...
    public void handleRespawn(S07PacketRespawn packetIn) {
        ...
        // Client
        Naven.getInstance().getEventManager().call(new EventRespawn(EventType.RESPAWN));
    }
