...
public abstract class EntityLivingBase extends Entity {
    ...
    public void onEntityUpdate() {
        ...
        Naven.getInstance().getEventManager().call(new EventLivingUpdate(this));
    ...
    public void onLivingUpdate() {
        ...
        if (this.isJumping) {
            if (this.isInWater() && !NoLiquid.shouldCancelLiquid) {
                ...
                this.handleJumpLava();
            } else if (this.onGround && (this.jumpTicks == 0 || Naven.getInstance().getModuleManager().getModule(NoJumpDelay.class).isEnabled())) {
                this.jump();
                this.jumpTicks = 10;
            }
        } else {
