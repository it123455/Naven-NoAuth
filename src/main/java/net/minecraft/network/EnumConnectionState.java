...
public enum EnumConnectionState {
    ...
    private static Map<Class<? extends Packet>, EnumPacketDirection> DIRECTION_MAP;
    ...
    public static EnumPacketDirection getDirection(Packet<?> packet) {
        if (DIRECTION_MAP == null) {
            return null;
        }

        return DIRECTION_MAP.get(packet.getClass());
    }

    protected EnumConnectionState registerPacket(EnumPacketDirection direction, Class<? extends Packet> packetClass) {
        if (DIRECTION_MAP == null) {
            DIRECTION_MAP = Maps.newHashMap();
        }

        DIRECTION_MAP.put(packetClass, direction);
