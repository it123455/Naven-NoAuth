...
public class NetworkManager extends SimpleChannelInboundHandler<Packet> {
    ...
    protected void channelRead0(ChannelHandlerContext p_channelRead0_1_, Packet p_channelRead0_2_) throws Exception {
        ...
        Naven.getInstance().getEventManager().call(globalEvent);
        ...
        // Client
        EventPacket event = new EventPacket(EventType.RECEIVE, p_channelRead0_2_);
            ...
            if (isHighVersion) {
                ...
                if (iterator.hasNext()) {
                    ...
                    if (packet instanceof CPacketPlayerTryUseItem) {
                        ...
                        PacketUtil.sendToServer(useItem, Protocol1_8To1_9.class, false, false);
    ...
    public void sendPacket(Packet<?> packetIn) {
        ...
        Naven.getInstance().getEventManager().call(globalPacket);
