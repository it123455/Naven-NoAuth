...
public abstract class BlockLiquid extends Block {
    ...
    public boolean isBlockSolid(IBlockAccess worldIn, BlockPos pos, EnumFacing side) {
        if (ViaLoadingBase.getInstance().getTargetVersion().getVersion() > ProtocolVersion.v1_12.getVersion()) {
            return causesDownwardCurrent(worldIn, pos, side);
        }
    ...
    {
        return attachBlock instanceof BlockLeaves || attachBlock instanceof BlockTrapDoor || attachBlock == Blocks.beacon || attachBlock == Blocks.cauldron || attachBlock == Blocks.glass || attachBlock == Blocks.glowstone || attachBlock == Blocks.ice || attachBlock == Blocks.sea_lantern || attachBlock == Blocks.stained_glass;
    }
    ...
    private boolean causesDownwardCurrent(IBlockAccess worldIn, BlockPos pos, EnumFacing side)
    {
        ...
        else
        {
            ...
            return !flag && iblockstate.getBlock().isBlockSolid(worldIn, pos, side);
        }
    }
